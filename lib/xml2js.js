...
(function() {
  var bom, builder, escapeCDATA, events, isEmpty, processName, processors, requiresCDATA, sax, trySaxParse, tryValidate, wrapCDATA,
  ...
  tryValidate = function(that, xpath, s, nodeName, obj) {
    var err;
    try {
      return obj = that.options.validator(xpath, s && s[nodeName], obj);
    } catch (_error) {
      err = _error;
  ...
  trySaxParse = function(that, str) {
    ...
    try {
      ...
      return that.saxParser.write(str).close();
    } catch (_error) {
      err = _error;
      if (!(that.saxParser.errThrown || that.saxParser.ended)) {
        that.emit('error', err);
        return that.saxParser.errThrown = true;
      ...
      this.saxParser.onclosetag = (function(_this) {
        return function() {
          ...
          if (_this.options.validator != null) {
            ...
            tryValidate(_this, xpath, s, nodeName, obj);
          }
